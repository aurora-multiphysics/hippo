...
bool
FoamMassFlowRateMappedInletBC::intersectMapPlane(const Foam::fvMesh & mesh, Real cart_bbox[6])
{
...
void
FoamMassFlowRateMappedInletBC::createMapComm(const Foam::fvMesh & mesh,
