...
class TestFoamBCMappedInlet(unittest.TestCase):
    ...
    def test_mapped_inlet(self):
        ...
        for i in range(len(TIMES)):
            self._check_u_temp_refs(i, "left", [1.0, 0, 0])
            self._check_u_temp_refs(i, "bottom", [0, 1.0, 0])
            self._check_u_temp_refs(i, "front", [0, 0, 1.0])
    ...
    def test_mapped_inlet_subtract(self):
        ...
        for i in range(len(TIMES)):
            self._check_u_temp_refs(i, "left", [1.0, 0, 0], False)
            self._check_u_temp_refs(i, "bottom", [0, 1.0, 0], False)
            self._check_u_temp_refs(i, "front", [0, 0, 1.0], False)
    ...
    def test_mapped_inlet_face_point(self):
        ...
        for i in range(len(TIMES)):
            self._check_u_temp_refs(i, "left", [7.0 / 8, 0, 0])
            self._check_u_temp_refs(i, "bottom", [0, 7.0 / 8, 0])
            self._check_u_temp_refs(i, "front", [0, 0, 7.0 / 8])
