...
class TestFoamBCFixedValuePostprocessor(unittest.TestCase):
    """Test class for imposing fixed value BCs in Hippo using postprocessors."""
    ...
    def test_fixed_value(self):
        ...
        for time in times:
            for boundary in boundaries:
                ...
                scale = 1.0 if boundary in ("left", "right", "top") else 2.0
